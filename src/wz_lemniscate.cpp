    ...
    while(ros::ok()){         
            ...
            switch(flag){
                case 0:
                        ...
                        c_pos_sp.position.x = r*cos(wn*0.01*counterc0)/(1+sin(wn*0.01*counterc0)*sin(wn*0.01*counterc0));
                        c_pos_sp.position.y = r*sin(wn*0.01*counterc0)*cos(wn*0.01*counterc0)/(1+sin(wn*0.01*counterc0)*sin(wn*0.01*counterc0));
